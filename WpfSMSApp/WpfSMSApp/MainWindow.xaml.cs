    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private void MetroWindow_Activated(object sender, EventArgs e)
        {
            if (Commons.LOGINED_USER != null)
                BtnLoginedId.Content = $"{ Commons.LOGINED_USER.UserEmail} ({Commons.LOGINED_USER.UserName})";  // 우측상단에 로그인 정보

        }

        private async void BtnLogOut_Click(object sender, RoutedEventArgs e)
        {
            // TODO : 로그아웃누르면 모든 화면을 해제하고 첫 화면으로 돌려놔야함 !!!!
            ...
            {
                Commons.LOGINED_USER = null;  // 로그인 했던 사용자 정보를 삭제 
                ShowLoginView(); 
            }
        }
